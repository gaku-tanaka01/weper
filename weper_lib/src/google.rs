...
pub fn get_first_google_result_html_element(
    html: &Html,
) -> Result<scraper::ElementRef, Box<dyn Error>> {
...
mod tests {
    ...
    "#;
        ...
        let result = get_first_google_result_html_element(&html);
        ...
        if let Ok(element) = result {
            ...
            assert!(element
                .value()
                .has_class("hlcw0c", scraper::CaseSensitivity::AsciiCaseInsensitive));
        }
    }
